        ...
        <section className="relative px-4 pt-12 pb-12 md:px-8">
          <div className="max-w-[1800px] mx-auto">
            ...
            <div className="mt-8 text-center flex justify-center items-center gap-4">
               ...
               <p className="text-xs font-bold uppercase tracking-[0.2em] text-text-secondary">No hype. No guilt. Just work.</p>
               <span className="h-px w-12 bg-border"></span>
            </div>
          </div>
        </section>
             ...
             <div className="grid md:grid-cols-2 gap-20 items-center">
                <div>
                  <h2 className="font-display text-6xl md:text-8xl uppercase font-bold text-text-primary mb-8 leading-[0.9] tracking-tighter">
                    Human First. <br/><span className="text-text-secondary">Athlete Second.</span>
                  </h2>
          ...
          <div className="max-w-5xl mx-auto">
             ...
             <div className="grid md:grid-cols-3 gap-8 text-left">
               <div className="bg-primary/10 p-10 rounded-3xl border border-primary/20 hover:border-accent transition-colors duration-300">
                 <h3 className="font-display text-3xl text-primary mb-4 uppercase">Trust & Clarity</h3>
                 <p className="text-primary/60">You want a clear plan you can trust, not random workouts or entertainment.</p>
               </div>
               <div className="bg-primary/10 p-10 rounded-3xl border border-primary/20 hover:border-accent transition-colors duration-300">
                 <h3 className="font-display text-3xl text-primary mb-4 uppercase">Honesty</h3>
                 <p className="text-primary/60">You prefer honest feedback over motivational speeches and hype.</p>
               </div>
               <div className="bg-primary/10 p-10 rounded-3xl border border-primary/20 hover:border-accent transition-colors duration-300">
                 <h3 className="font-display text-3xl text-primary mb-4 uppercase">Standards</h3>
                 <p className="text-primary/60">You care about doing this properly. You’re ready to show up.</p>
               </div>
             </div>
          </div>
        </section>
          ...
          <div className="max-w-[1600px] mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              ...
              <Link to="/personal-training" className="group block">
                ...
                <p className="text-text-secondary font-medium max-w-sm">In-person sessions + app homework. Precision coaching.</p>
              </Link>
              ...
              <Link to="/online-coaching" className="group block lg:mt-24">
                ...
                <p className="text-text-secondary font-medium max-w-sm">Structure, consistency, and guidance anywhere.</p>
              </Link>
              ...
              <Link to="/42-day-reset" className="group block">
                ...
                <p className="text-text-secondary font-medium max-w-sm">Self-guided app plan. Rebuild momentum.</p>
              </Link>
              ...
              <Link to="/corporate-wellness" className="group block lg:mt-24">
                ...
                <h3 className="font-display text-4xl uppercase font-bold mb-2 text-text-primary group-hover:text-accent transition-colors">Corporate Performance</h3>
                <p className="text-text-secondary font-medium max-w-sm">High-ROI wellness strategies for high-performing teams.</p>
              </Link>
