...
import { Clock, Activity, Target, ChevronDown, Star } from 'lucide-react';
...
export const Home: React.FC = () => {
  ...
  return (
    <>
      <SeoHead 
        title="Christchurch Personal Trainer for Fat Loss | WRK"
        description="WRK is Christchurch personal trainer Hayden Richards — fat loss and strength coaching for busy professionals aged 35 to 60. In Christchurch and online across NZ. 20 years experience."
      />
          ...
          <div className="max-w-[1200px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
               ...
               <div className="flex flex-col gap-4 bg-navy-mid p-8 rounded-[20px] border border-navy-light shadow-lg">
                 ...
                 <Link to="/workplace-wellness-program-nz" className="text-orange-burnt font-sans text-[14px] font-semibold hover:underline mt-4">
                   Learn more &rarr;
                 </Link>
               </div>
            </div>
              ...
              <div className="relative z-10 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <p className="font-sans text-[16px] md:text-[18px] text-off-white/90 leading-[1.6] max-w-[700px]">
                    14-Day Fat Loss Programme. Fourteen days, a daily plan in the app, and a coaching message from me every morning at 6:30am. $14. A real starting point, not a PDF you'll never open.
                  </p>
                </div>
