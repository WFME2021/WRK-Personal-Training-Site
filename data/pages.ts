...
export const PAGE_LABELS: Record<string, string> = {
  home: 'Home Page',
  personalTraining: 'In-Person PT',
  onlineCoaching: 'Coaching Membership',
  challenge42: '42-Day Challenge',
...
export const FIELD_LABELS: Record<string, string> = {
  ...
  ptImage: 'In-Person PT Card Image',
  onlineImage: 'Coaching Membership Card Image',
