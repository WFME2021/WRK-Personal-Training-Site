...
export const BLOG_POSTS: BlogPost[] = [
  ...
  },
  {
    ...
    content: "<p>Complexity is the enemy of execution. When starting out, your focus should be entirely on the compound lifts.</p><h2>1. The Squat</h2><p>The king of all exercises. It trains the entire posterior chain and core.</p><img src='https://i.postimg.cc/MKnbjvN1/dad-carrypack-hiking.jpg' alt='Athlete performing a back squat' /><p>Ensure your depth hits parallel and your chest stays up.</p><h2>2. The Deadlift</h2><p>The purest test of strength. Pick it up, put it down safely.</p>",
